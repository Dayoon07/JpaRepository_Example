...
<body>
    <div class="flex">
	    ...
	    <form action="${ cl }/deleteTable" method="post" autocomplete="off">
	    	<button type="submit" class="inline-block bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 m-5 rounded">테이블 내용 전체 삭제</button>
	    </form>
    </div>
    
    <form action="${ cl }/insertIntoTESTUSER" method="post" autocomplete="off" class="max-w-md mx-auto bg-white shadow-md border rounded px-8 pt-6 pb-8 mb-4 fixed bottom-0 right-0">
        <div class="mb-4">
