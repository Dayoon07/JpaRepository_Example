...
<body>
	...
	<div class="container mx-auto mt-10">
        ...
        <form action="${ cl }/updating/${ userentityinfo.ID }" method="post" class="bg-white border shadow-md rounded px-8 pt-6 pb-8 mb-4">
            <div class="mb-4">
                <label class="block text-gray-700 text-xl font-bold mb-2" for="ID">고유 ID : ${ userentityinfo.ID }번</label>
            </div>
            
            <div class="mb-4">
                <label class="block text-gray-700 text-lg font-bold mb-2" for="username">이름 </label>
            ...
            <div class="mb-4">
                <label class="block text-gray-700 text-lg font-bold mb-2" for="email">이메일</label>
            ...
            <div class="mb-4">
                <label class="block text-gray-700 text-lg font-bold mb-2" for="phone">비밀번호</label>
